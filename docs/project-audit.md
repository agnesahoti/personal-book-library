...
Personal Book Library është një aplikacion për menaxhimin e librave personalë.  
Ai u mundëson përdoruesve të shtojnë, kërkojnë, editojnë dhe fshijnë libra nga koleksioni i tyre.  
Të dhënat ruhen në një file CSV në backend.
